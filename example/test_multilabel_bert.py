...
import json
import hiclre
from hiclre import encoder, model, framework
import sys
import os
import argparse
import logging
...
# Define the model
model = hiclre.model.SoftmaxNN(sentence_encoder, len(rel2id), rel2id)

# Define the whole training framework
framework = hiclre.framework.MultiLabelSentenceRE(
